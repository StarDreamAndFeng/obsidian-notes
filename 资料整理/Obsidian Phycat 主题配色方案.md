---
tags: [Obsidian, 主题, Phycat, 美化]
date: 2026-07-26
source: https://github.com/sumruler/obsidian-theme-phycat
---

# 🐱 Obsidian Phycat 主题

![Version](/images/obsidian-theme-phycat.svg) ![Downloads](/images/obsidian-theme-phycat-total.svg) ![License](/images/obsidian-theme-phycat-mit.svg)

**Phycat** 是一款充满活力、现代且高度可定制的 Obsidian 主题。它采用"玻璃拟态 (Glassmorphism)"美学设计，配色经过精心调校，旨在提供专注且舒适的视觉体验。

> 🎨 **设计理念**：极简的结构，极致的个性。

![Theme Screenshot](/images/screenshot-hd.png)
...
1. 从官方发布页下载字体文件 (`LXGWWenKai-Regular.ttf`)：[下载链接 (GitHub)](https://github.com/lxgw/LxgwWenKai/releases)
...
本主题遵循 MIT 许可证。详情请参阅 [LICENSE](https://github.com/sumruler/obsidian-theme-phycat/blob/main/LICENSE) 文件。
